...
exports.updateUser = functions.https.onRequest(async (req, res) => {
  ...
  try {
    const { name, email, skills } = req.body.data;

    // Define the user document ID, in this case, using email as a unique identifier
    const userId = email; // Or any other unique identifier for the user document
