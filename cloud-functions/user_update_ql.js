...
const schema = buildSchema(`
  ...
  type Mutation {
    updateUser(email: String!, name: String!, skills: [String]!): User
  }
  type User {
    email: String
    name: String
...
const root = {
  message: () => 'Hello World!',
  updateUser: async ({ email, name, skills }) => {
...
exports.graphqlUser = functions.https.onRequest(app);
